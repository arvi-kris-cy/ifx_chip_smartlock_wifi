...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        showViewController(viewController: ProvisionViewController.self, storyboardId: "ProvisionViewController")
    }
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            ...
            let vc = (storyboard.instantiateViewController(identifier: "PersonalizeCardViewController") as! PersonalizeCardViewController)
            self.navigationController?.pushViewController(vc, animated: true)
        case 2:
            let storyboard : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
            let vc = (storyboard.instantiateViewController(identifier: "SetupKeyPinViewController") as! SetupKeyPinViewController)
            self.navigationController?.pushViewController(vc, animated: true)
        case 3:
            let storyboard : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
            let vc = (storyboard.instantiateViewController(identifier: "AddDeviceViewController") as! AddDeviceViewController)
            self.navigationController?.pushViewController(vc, animated: true)
            
//        case 4:
//            let storyboard : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
//            let vc = (storyboard.instantiateViewController(identifier: "BatteryFrequencyViewController") as! BatteryFrequencyViewController)
//            self.navigationController?.pushViewController(vc, animated: true)
        case 4:
            let storyboard : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
            let vc = (storyboard.instantiateViewController(identifier: "MatterConfigurationViewController") as! MatterConfigurationViewController)
            self.navigationController?.pushViewController(vc, animated: true)
        case 5:
            let storyboard : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
            let vc = (storyboard.instantiateViewController(identifier: "OnOffAwsViewController") as! OnOffAwsViewController)
            self.navigationController?.pushViewController(vc, animated: true)
        default:
            break
        }
